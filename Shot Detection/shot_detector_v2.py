        ...
        while True:
            ...
            for r in results:
                ...
                for box in boxes:
                    ...
                    distance = math.sqrt((camera_center[0] - center[0])**2 + (camera_center[1] - center[1])**2)

                    cv2.putText(self.frame, f"Dist: {int(distance)} px", (x1, y1 - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 255), 2)
