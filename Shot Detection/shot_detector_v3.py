...
class ShotDetector:
    ...
    def run(self):
        while True:
            ...
            cv2.circle(self.frame, camera_center, 5, (0, 255, 0), -1)
            ...
            for r in results:
                ...
                for box in boxes:
                    ...
                    x = camera_center[0] - center[0]
                    y = camera_center[1] - center[1]

                    cv2.line(self.frame, camera_center, center, (255, 255, 0), 2)

                    cv2.putText(self.frame, f"X: {x} px, Y: {y}", (x1, y1 - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 255), 2)
